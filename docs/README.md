...
Current version: **Body Change NG v1.3.1**. See the [English changelog](../CHANGELOG.md#131), [한국어 변경 내역](../CHANGELOG-KO.md#131), [current usage / removal preparation](../README.md), [cache utility guide](../package/Tools/BodyChangeNGCache-README.txt), and [verification](RELEASE-VERIFICATION-v1.3.1-KO.md). Earlier version files remain historical records.

## Current v1.3.1 release documents

| Purpose | English | 한국어 |
| --- | --- | --- |
| Formatted changelog | [Nexus BBCode](NEXUS-CHANGELOG-v1.3.1-EN.bbcode) | [Standalone HTML](NEXUS-CHANGELOG-v1.3.1-KO.html) |
| Nexus changelog field | [Plain text](NEXUS-CHANGELOG-v1.3.1-EN.txt) | [일반 텍스트](NEXUS-CHANGELOG-v1.3.1-KO.txt) |
