...
Current version: **Body Change NG v1.3.0**. See the [English changelog](../CHANGELOG.md#130), [한국어 변경 내역](../CHANGELOG-KO.md#130), [current usage / removal preparation](../README.md), and [verification](RELEASE-VERIFICATION-v1.3.0-KO.md). Earlier version files remain historical records.

## Current v1.3.0 release documents

| Purpose | English | 한국어 |
| --- | --- | --- |
| Formatted changelog | [Nexus BBCode](NEXUS-CHANGELOG-v1.3.0-EN.bbcode) | [Standalone HTML](NEXUS-CHANGELOG-v1.3.0-KO.html) |
| Nexus changelog field | [Plain text](NEXUS-CHANGELOG-v1.3.0-EN.txt) | [일반 텍스트](NEXUS-CHANGELOG-v1.3.0-KO.txt) |
