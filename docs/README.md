...
Current version: **Body Change NG v1.2.2**. The [English changelog](../CHANGELOG.md#122) and [한국어 변경 내역](../CHANGELOG-KO.md#122) cover case-variant morph-name fixes while retaining Futanari Skin favorites, OBody/OClothe cleanup and sex-specific NPC preview selection. Previous release documents remain unchanged historical records.

| Purpose | English | 한국어 |
| --- | --- | --- |
| Full description and usage | [Nexus BBCode](NEXUS-DESCRIPTION-v1.2.2-EN.bbcode) · [Markdown](NEXUS-DESCRIPTION-v1.2.2.md) | [Standalone HTML](NEXUS-DESCRIPTION-v1.2.2-KO.html) |
| Formatted changelog | [BBCode](NEXUS-CHANGELOG-v1.2.2-EN.bbcode) | [Standalone HTML](NEXUS-CHANGELOG-v1.2.2-KO.html) |
| Nexus changelog field | [Plain text](NEXUS-CHANGELOG-v1.2.2-EN.txt) | [일반 텍스트](NEXUS-CHANGELOG-v1.2.2-KO.txt) |
| Full version history | [Markdown](../CHANGELOG.md) | [Markdown](../CHANGELOG-KO.md) |
| Upgrade notes and verification boundary | [Markdown](RELEASE-NOTES-v1.2.2.md) | [Markdown](RELEASE-NOTES-v1.2.2-KO.md) |
...
Current verification evidence: [v1.2.2 build and test results](RELEASE-NOTES-v1.2.2.md). Historical audits: [compatibility and UI](COMPATIBILITY-UI-20260912-KO.md) · [raw tests](COMPATIBILITY-UI-20260912-TESTS.json) · [full audit](FULL-AUDIT-20260912-KO.md).
