...
Current release: **Body Change NG 1.1.1**.

1.1.1 engineering records: [load/lifecycle safety](LIFECYCLE-SAFETY-FOLLOWUP-2026-09-04-KO.md) · [direct-selection responsiveness](RESPONSIVENESS-SAFETY-FOLLOWUP-2026-09-05-KO.md). Historical records describe their own checkpoints; current public behavior and update precautions are in the 1.1.1 release notes.
...
| Release notes and upgrade precautions | [Markdown](RELEASE-NOTES-v1.1.1.md) | [Markdown](RELEASE-NOTES-v1.1.1-KO.md) |
