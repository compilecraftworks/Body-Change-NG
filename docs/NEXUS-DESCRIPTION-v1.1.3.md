...
- **Actor-aware futanari skins** — a conditional catalog supports the active UBE SOS/TNG, UBE/CBBE TRX, or CBBE 3BA ERF genital type, including optional wet companion textures; selections remain visible through later BodySkin refreshes and update immediately on RaceMenu v0/v1 and v2
