Body Changer NG - 틴트팩 설치 안내

이 폴더 아래에 틴트팩마다 별도의 폴더를 만드세요.
...
게임 실행 중 폴더를 추가했다면 Body Changer NG의 틴트 탭에서
새로고침을 누르세요. 각 최상위 틴트팩 폴더가 목록의 한 항목이 됩니다.

English:
Create one folder per tint pack and keep RaceMenu tint DDS files under
