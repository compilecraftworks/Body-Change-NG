...
namespace
{
    constexpr std::string_view kMenuName = "BodyChangeNGMenu";
    ...
    void RemoveWindowMessageHook()
    {
        ...
        if (reinterpret_cast<WNDPROC>(GetWindowLongPtr(g_window, GWLP_WNDPROC)) == &BodyChangeWindowProc) {
    ...
    void ApplyStyle()
    {
        ...
        const ImVec4 background{ 0.055F, 0.055F, 0.055F, 1.0F };
        const ImVec4 panel{ 0.075F, 0.075F, 0.075F, 1.0F };
        const ImVec4 frame{ 0.125F, 0.125F, 0.125F, 1.0F };
        const ImVec4 border{ 0.285F, 0.285F, 0.285F, 1.0F };

        colors[ImGuiCol_Text] = ImVec4(0.925F, 0.925F, 0.925F, 1.0F);
        colors[ImGuiCol_TextDisabled] = ImVec4(0.555F, 0.555F, 0.555F, 1.0F);
        ...
        colors[ImGuiCol_TitleBg] = ImVec4(0.080F, 0.080F, 0.080F, 1.0F);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.145F, 0.145F, 0.145F, 1.0F);
        colors[ImGuiCol_TitleBgCollapsed] = background;
        colors[ImGuiCol_MenuBarBg] = ImVec4(0.090F, 0.090F, 0.090F, 1.0F);
        colors[ImGuiCol_ScrollbarBg] = ImVec4(0.045F, 0.045F, 0.045F, 1.0F);
        colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.265F, 0.265F, 0.265F, 1.0F);
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.360F, 0.360F, 0.360F, 1.0F);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.455F, 0.455F, 0.455F, 1.0F);
        colors[ImGuiCol_CheckMark] = ImVec4(0.50F, 0.80F, 0.95F, 1.0F);
        colors[ImGuiCol_CheckboxSelectedBg] = ImVec4(0.20F, 0.39F, 0.50F, 1.0F);
        colors[ImGuiCol_SliderGrab] = ImVec4(0.30F, 0.49F, 0.61F, 1.0F);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.50F, 0.80F, 0.95F, 1.0F);
        ...
        colors[ImGuiCol_SeparatorHovered] = ImVec4(0.470F, 0.470F, 0.470F, 1.0F);
        colors[ImGuiCol_SeparatorActive] = ImVec4(0.620F, 0.620F, 0.620F, 1.0F);
        colors[ImGuiCol_ResizeGrip] = ImVec4(0.285F, 0.285F, 0.285F, 0.70F);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.470F, 0.470F, 0.470F, 0.90F);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.620F, 0.620F, 0.620F, 1.0F);
        colors[ImGuiCol_InputTextCursor] = ImVec4(0.50F, 0.80F, 0.95F, 1.0F);
        colors[ImGuiCol_TabHovered] = ImVec4(0.25F, 0.50F, 0.63F, 1.0F);
        colors[ImGuiCol_Tab] = frame;
        colors[ImGuiCol_TabSelected] = ImVec4(0.20F, 0.39F, 0.50F, 1.0F);
        colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.50F, 0.80F, 0.95F, 1.0F);
        colors[ImGuiCol_TabDimmed] = ImVec4(0.095F, 0.095F, 0.095F, 1.0F);
        colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.185F, 0.185F, 0.185F, 1.0F);
        colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.520F, 0.520F, 0.520F, 1.0F);
        colors[ImGuiCol_PlotLines] = ImVec4(0.650F, 0.650F, 0.650F, 1.0F);
        colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.900F, 0.900F, 0.900F, 1.0F);
        colors[ImGuiCol_PlotHistogram] = ImVec4(0.610F, 0.610F, 0.610F, 1.0F);
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.875F, 0.875F, 0.875F, 1.0F);
        colors[ImGuiCol_TableHeaderBg] = ImVec4(0.155F, 0.155F, 0.155F, 1.0F);
        colors[ImGuiCol_TableBorderStrong] = border;
        colors[ImGuiCol_TableBorderLight] = ImVec4(0.205F, 0.205F, 0.205F, 1.0F);
        colors[ImGuiCol_TableRowBg] = transparent;
        colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.120F, 0.120F, 0.120F, 0.45F);
        colors[ImGuiCol_TextLink] = ImVec4(0.780F, 0.780F, 0.780F, 1.0F);
        colors[ImGuiCol_TextSelectedBg] = ImVec4(0.410F, 0.410F, 0.410F, 0.60F);
        colors[ImGuiCol_TreeLines] = ImVec4(0.420F, 0.420F, 0.420F, 1.0F);
        colors[ImGuiCol_DragDropTarget] = ImVec4(0.900F, 0.900F, 0.900F, 1.0F);
        colors[ImGuiCol_DragDropTargetBg] = ImVec4(0.450F, 0.450F, 0.450F, 0.30F);
        colors[ImGuiCol_UnsavedMarker] = ImVec4(0.820F, 0.820F, 0.820F, 1.0F);
        colors[ImGuiCol_NavCursor] = ImVec4(0.50F, 0.80F, 0.95F, 1.0F);
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.900F, 0.900F, 0.900F, 0.70F);
    ...
    [[nodiscard]] bool BuildFonts(ImGuiIO& io, const float pixelSize)
    {
        ...
        if (!io.Fonts->Build()) {
            SKSE::log::error("Body Change NG could not build the ImGui font atlas");
            return false;
        }
        ...
        if (!texture || texture->Width <= 0 || texture->Height <= 0 ||
            ...
            SKSE::log::error("Body Change NG rejected the ImGui font atlas dimensions");
            return false;
        }
        return true;
    }
        ...
        ID3D11DeviceContext* context)
    {
        ...
        if (!BuildFonts(io, kFontPixelSize * g_resolutionScale) || !ValidateFontTexture(device, io)) {
            SKSE::log::error("Body Change NG did not attach ImGui because D3D11 rejected its font texture");
            ResetRenderer();
        ...
        if (!InstallWindowMessageHook(g_window)) {
            SKSE::log::warn("Body Change NG will rely on Skyrim's normal input route for scrolling");
        }
        ImGui::SetCurrentContext(old);
        SKSE::log::info("Body Change NG native ImGui D3D11 host initialized");
        return true;
    }
    ...
    void AcquireCursor()
    {
        ...
        // different menu may hide it while Body Change NG remains open, so
    ...
    struct D3DInitHook
    {
        static void Thunk()
        {
            ...
            if (InitializeRenderer(swapChain, device, context)) {
                if (!RegisterNativeMenu()) SKSE::log::critical("Body Change NG could not register its native menu");
            }
        }
...
namespace bcn::native_ui
{
    ...
    bool InstallRendererHook()
    {
        ...
        if (!layout) {
            SKSE::log::critical("Body Change NG native ImGui is disabled: Skyrim {} has no verified renderer hook layout", version.string());
            return false;
        }
        ...
        if (*reinterpret_cast<const std::uint8_t*>(callSite) != 0xE8) {
            SKSE::log::critical("Body Change NG native ImGui is disabled: renderer hook signature mismatch");
            return false;
        }
        D3DInitHook::func = SKSE::GetTrampoline().write_call<5>(callSite, D3DInitHook::Thunk);
        g_hookInstalled = true;
        SKSE::log::info("Body Change NG installed a verified renderer hook for Skyrim {}", version.string());
        return true;
    }
