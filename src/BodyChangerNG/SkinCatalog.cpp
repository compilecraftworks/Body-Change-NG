...
namespace
{
    ...
    void ApplyToPlayerNow(RE::ActorHandle playerHandle, const bcn::SkinEntry entry)
    {
        ...
        SKSE::log::info("Body Changer NG applied BodyChange skin '{}' to the player", entry.name);
    }
}
...
namespace bcn
{
    ...
    void SkinCatalog::Refresh()
    {
        ...
        SKSE::log::info("Body Changer NG found {} optional BodyChange player skin presets", entries_.size());
    }
